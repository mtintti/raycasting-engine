...
public:
    ...
    void DebugDrawPoint(float x, float y, float size); // debug test
    void DebugDrawLine(float x1, float y1, float x2, float y2); // debug test
    void DebugDrawLinepast(float x1, float y1, float x2, float y2); // debug test
